...
<section className="">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-blue-600">ABOUT US</h2>
          <h3 className="mb-4 text-4xl tracking-tight  text-blue-600"> <span className="font-bold">LASVEC</span> is Lagos State's Official Electronic Voting System, used to conduct credible and transparent elections from anywhere, at any time.</h3>
          <p className="font-light text-gray-500 lg:mb-16 sm:text-xl">We aim to revolutionize the electoral process in Lagos State with LASVEC, a cutting-edge e-voting platform designed to make elections more accessible, secure, and transparent.</p>
      </div> 
      <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
    ...
    <a href="#">
        ...
        <span className="text-gray-500 group-hover:text-white">CEO & Web Developer</span>
