...
function Testimony() {
  ...
  return (
    <div className="relative px-4 py-12 pb-16">
      ...
      <ArrowLeftCircle color='blue'/>
        </button>

        <p className="text-lg font-medium text-blue-900 pt-1">
        ...
        <button className="bg-gray-200 hover:bg-gray-300 rounded-full p-2 pt-2" onClick={handleNextClick}>
